  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: ':resource(users|roles|permissions)', name: 'resource-list', component: () => import('@/modules/resources/pages/ResourceListPage.vue') },
        ...
        { path: ':resource(users|roles|permissions)/:id', name: 'resource-detail', component: () => import('@/modules/resources/pages/ResourceDetailPage.vue') },
