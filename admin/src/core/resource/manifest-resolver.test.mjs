...
import { findResourceManifest, frontendResourceRoute } from './manifest-resolver.ts'
...
assert.equal(frontendResourceRoute({ route: '/admin/departments' }, 'departments'), '/departments')
