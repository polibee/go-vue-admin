...
func Web() {
	...
	facades.Route().Get("/api/modules", extensionController.Modules)
	facades.Route().Get("/api/modules/:id", extensionController.ModuleShow)
	facades.Route().Get("/api/plugins", extensionController.Plugins)
	facades.Route().Get("/api/plugins/:id", extensionController.PluginShow)
	facades.Route().Put("/api/plugins/:id/state", extensionController.UpdatePlugin)
