...
foreach ($path in @("/auth/login", "/auth/refresh", "/auth/logout-all", "/auth/me", "/admin/registry", "/admin/search", "/admin/{resource}", "/admin/{resource}/{id}", "/admin/overview", "/admin/audit-logs", "/admin/users/status")) {
