...
func resourceManifestSchema() map[string]any {
	return map[string]any{"type": "object", "required": []string{"name", "label", "admin_route", "api_base", "permissions", "navigation", "fields", "columns"}, "properties": map[string]any{"name": map[string]any{"type": "string"}, "label": map[string]any{"type": "string"}, "admin_route": map[string]any{"type": "string", "pattern": "^/admin/"}, "api_base": map[string]any{"type": "string", "pattern": "^/api/v1/admin/"}, "permissions": map[string]any{"type": "array", "items": map[string]any{"type": "string"}}, "navigation": map[string]any{"type": "object", "required": []string{"group", "order"}, "properties": map[string]any{"group": map[string]any{"type": "string"}, "order": map[string]any{"type": "integer"}, "hidden": map[string]any{"type": "boolean"}}}, "data_scope": map[string]any{"$ref": "#/components/schemas/DataScope"}, "owner_field": map[string]any{"type": "string"}, "soft_delete": map[string]any{"type": "boolean"}, "fields": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceField"}}, "columns": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceColumn"}}, "actions": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceAction"}}, "filters": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceFilter"}}, "relations": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceRelation"}}, "form_groups": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceFormGroup"}}, "details": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceDetailSection"}}, "dependencies": map[string]any{"type": "array", "items": map[string]any{"$ref": "#/components/schemas/ResourceFieldDependency"}}}}
}
