...
var CoreEndpoints = []CoreEndpoint{
	...
	{Method: "GET", Path: "/api/modules", Description: "Lists compiled business modules."},
	{Method: "GET", Path: "/api/modules/:id", Description: "Returns one compiled business module."},
	{Method: "GET", Path: "/api/plugins", Description: "Lists builtin platform plugins."},
	{Method: "GET", Path: "/api/plugins/:id", Description: "Returns one builtin platform plugin."},
	{Method: "PUT", Path: "/api/plugins/:id/state", Description: "Enables or disables a builtin plugin. Requires plugins.manage and CSRF."},
