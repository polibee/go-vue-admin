...
<!-- Generated form scaffold. Connect it to the shared form/API contract before activation. -->
<template>
  <section class="space-y-4">
    <header>
      <h1>{{ resourceDefinition.label }} form</h1>
      <p>Review fields and connect the resource form contract before registering this route.</p>
    </header>
    <ul>
      <li v-for="field in resourceDefinition.fields" :key="field.name">
