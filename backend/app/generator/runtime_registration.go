...
func generatedFrontendRegistry(resources []generatedResource) string {
	...
	for _, item := range resources {
		...
		fmt.Fprintf(&routes, "  { path: %s.admin_route, name: %q, props: { resource: %s.name }, meta: { permission: %s.permission }, component: %s },\n", alias, item.Name+"-resource-list", alias, alias, listComponent)
		fmt.Fprintf(&routes, "  { path: %s.admin_route + '/new', name: %q, props: { resource: %s.name }, meta: { permission: %s.permission }, component: %s },\n", alias, item.Name+"-resource-create", alias, alias, formComponent)
		fmt.Fprintf(&routes, "  { path: %s.admin_route + '/:id/edit', name: %q, props: { resource: %s.name }, meta: { permission: %s.permission }, component: %s },\n", alias, item.Name+"-resource-edit", alias, alias, formComponent)
		fmt.Fprintf(&routes, "  { path: %s.admin_route + '/:id', name: %q, props: { resource: %s.name }, meta: { permission: %s.permission }, component: %s },\n", alias, item.Name+"-resource-detail", alias, alias, detailComponent)
	}
